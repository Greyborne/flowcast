...
export default function ScheduleTab() {
  ...
  if (isLoading) {
    return <div className="flex items-center justify-center h-48 text-gray-500">Loading settings...</div>;
  }
    ...
    <div className="space-y-6">
      ...
      <section className="bg-gray-900 rounded-xl border border-gray-800 p-6 space-y-5">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-gray-600">Your first (or most recent) payday — the schedule is built from this date forward.</p>
          <input
            type="date"
      ...
      <section className="bg-gray-900 rounded-xl border border-amber-800/40 p-6 space-y-4">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">
            ...
            Reconciled periods are never touched.
          </p>
          <p className="text-xs text-gray-600 mt-1">Tip: Save your settings first, then regenerate.</p>
        </div>
